#
# $Header: /usr/local/sbin/gentoo.periodic/RCS/readme.txt,v 1.4 2009/09/06 22:03:21 root Exp $
...
funciton, singular report) Standard Output generated by cron running the
...
1. Place the gentoo.periodic/ directory in /usr/local/sbin/
...
Q: But doesn't logwatch do the same thing?
A: No. Logwatch is a fantastic utility, and I would encourage its use, however 
it only looks at logs. I wanted something that would give me a much more broad  
